...
import { getVenues, getVenueById, createVenue, updateVenue, deleteVenue, getVenuesByUserId } from '../controllers/venueController.js';
...
router.get('/venuesByUserId/:userId', authenticateToken(['musician', 'venue']), getVenuesByUserId);
